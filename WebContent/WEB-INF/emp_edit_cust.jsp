...
<div class="row">
    ...
    <div class="medium-8 columns ">
        ...
        <div class="medium-12 columns" style="border-bottom:thin solid #1F1F1F;" ><h3 id="title" style="text-align:center">Edit Customer</h3></div>
    	<form method="POST" action="Employee?action=7">
    		<div class="medium-8 medium-centered columns" style="margin-top:15%; margin-bottom:15%;">
    			<div class="row">
    				...
    				<div class="medium-4 columns ">
            			<label style="padding:9px 0px"><b>Email:</b></label>
    				</div>
            		<div class="medium-8 columns ">
      					<input name="email_txt" type="text" placeholder="Enter the email" />
    				</div>
    				<div class="medium-4 columns ">
            			<label style="padding:9px 0px"><b>CreditCard#:</b></label>
    				</div>
            		<div class="medium-8 columns ">
      					<input name="ccn_txt" type="text" placeholder="Enter the credit card #" />
    				</div>
  				</div>
        		<div class="top-bar-right">
                	<ul class="menu">
                   		<li style="padding-right:15px" id="register_btn"><input class="button" type="submit" value= "Edit Customer" /></li>
                	</ul>
         		</div>
    		</div>
    	</form>	
