...
<div class="row">
    ...
    <div class="medium-8 columns ">
        ...
        <div class="medium-12 columns" style="border-bottom:thin solid #1F1F1F;" ><h3 id="title" style="text-align:center">Add Customer</h3></div>
    	<form method="POST" action="Employee?action=5">
    		<div class="medium-8 medium-centered columns" style="margin-top:15%; margin-bottom:15%;">
        		...
        		<div class="top-bar-right">
                	<ul class="menu">
                   		<li style="padding-right:15px" id="register_btn"><input class="button" type="submit" value= "Add Customer" /></li>
                	</ul>
         		</div>
    		</div>
    	</form>	
