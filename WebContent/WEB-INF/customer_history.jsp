			...
			<div class="row">
				...
				<div class="medium-8 columns ">
					...
					<div class="medium-12 columns"
						...
						<h3 id="title" style="text-align: center">History</h3>
					</div>
					<table style="width: 100%">
						...
						<c:forEach items="${Orders}" var="order">
							<tr>
								...
								<td style="text-align: center">${order.movieid}</td>
								<td style="text-align: center">${order.custrepid}</td>
								<td style="text-align: center">${order.datetime}</td>
								<td style="text-align: center">${order.returndate}</td>
							</tr>
						</c:forEach>
					</table>
