						...
						<div class="medium-12 medium columns">
							<div class="row">
								<div class="medium-7 columns ">
									<form method="POST" action="Customer?action=7">
										<input type="text" name="search_text1"
			...
			<div class="row">
				...
				<div class="medium-8 columns ">
					...
					<div class="medium-12 columns"
						...
						<h3 id="title" style="text-align: center">Keyword</h3>
					</div>
					<table style="width: 100%">
						...
						<c:forEach items="${keyword_list}" var="movie">
							<tr>
